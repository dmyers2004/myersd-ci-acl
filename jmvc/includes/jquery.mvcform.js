...
/*
Send form to url from form's action attribute + validation_url setting ie action="submit" url = submit_validate
...
*/
  ...
  mvc.ajax_responds = jQuery.mvcAjax({"url": url,"data": data });
